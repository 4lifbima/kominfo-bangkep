<x-app-layout>
    <x-slot:title>Layanan Publik</x-slot>

    <!-- Header & Actions -->
    <div class="flex flex-col md:flex-row justify-between items-start md:items-end gap-4 animate-fade-up">
        <div>
            <h2 class="text-2xl font-bold tracking-tight text-slate-900 dark:text-white mb-1">Layanan Publik</h2>
            <p class="text-slate-500 dark:text-slate-400 text-sm">Kelola daftar layanan dan aplikasi publik.</p>
        </div>
        <a href="{{ route('services.create') }}" class="flex items-center gap-2 px-4 py-2.5 bg-gradient-primary text-white rounded-lg text-sm font-medium shadow-lg shadow-indigo-500/25 hover:opacity-90 transition-all">
    ...
    <div class="glass-panel rounded-2xl p-6 shadow-glass animate-fade-up" style="animation-delay: 0.1s;">
        ...
        <div class="overflow-x-auto">
            <table id="servicesTable" class="w-full text-sm text-left">
