<x-app-layout>
    <x-slot:title>Tambah Data Statistik</x-slot>
    ...
    <div class="flex items-center gap-4 animate-fade-up">
        ...
        <div>
            <h2 class="text-2xl font-bold tracking-tight text-slate-900 dark:text-white">Tambah Data Statistik</h2>
            <p class="text-slate-500 dark:text-slate-400 text-sm">Input data statistik atau indikator kinerja baru.</p>
        </div>
    </div>
    ...
    <div class="glass-panel rounded-2xl p-6 shadow-glass animate-fade-up mt-6 max-w-3xl" style="animation-delay: 0.1s;">
        <form action="{{ route('statistics.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="label" id="label" class="w-full rounded-lg border-slate-300 dark:border-white/10 bg-slate-50 dark:bg-white/5 text-sm focus:border-primary focus:ring focus:ring-primary/20 p-2.5" placeholder="Contoh: Indeks SPBE" required>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="value" id="value" class="w-full rounded-lg border-slate-300 dark:border-white/10 bg-slate-50 dark:bg-white/5 text-sm focus:border-primary focus:ring focus:ring-primary/20 p-2.5" placeholder="Contoh: 3.5, 85%" required>
                </div>
                <div>
                    <label for="unit" class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Satuan (Opsional)</label>
                    <input type="text" name="unit" id="unit" class="w-full rounded-lg border-slate-300 dark:border-white/10 bg-slate-50 dark:bg-white/5 text-sm focus:border-primary focus:ring focus:ring-primary/20 p-2.5" placeholder="Contoh: Indeks, Persen, Jiwa">
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="category" id="category" class="w-full rounded-lg border-slate-300 dark:border-white/10 bg-slate-50 dark:bg-white/5 text-sm focus:border-primary focus:ring focus:ring-primary/20 p-2.5">
                        ...
                        <option value="Infrastruktur">Data Infrastruktur</option>
                        <option value="Kependudukan">Kependudukan</option>
                        <option value="Anggaran">Keuangan & Anggaran</option>
